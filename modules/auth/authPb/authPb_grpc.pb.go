...
type AuthGrpcServiceClient interface {
	...
	RegisterNewUser(ctx context.Context, in *RegisterNewUserReq, opts ...grpc.CallOption) (*RegisterNewUserRes, error)
}
...
func (c *authGrpcServiceClient) DeleteUser(ctx context.Context, in *DeleteUserReq, opts ...grpc.CallOption) (*DeleteUserRes, error) {
	...
	err := c.cc.Invoke(ctx, "/AuthGrpcService/DeleteUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authGrpcServiceClient) GetUidFromEmail(ctx context.Context, in *GetUidFromEmailReq, opts ...grpc.CallOption) (*GetUidFromEmailRes, error) {
	...
	err := c.cc.Invoke(ctx, "/AuthGrpcService/GetUidFromEmail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authGrpcServiceClient) RegisterNewUser(ctx context.Context, in *RegisterNewUserReq, opts ...grpc.CallOption) (*RegisterNewUserRes, error) {
	out := new(RegisterNewUserRes)
	err := c.cc.Invoke(ctx, "/AuthGrpcService/RegisterNewUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthGrpcServiceServer interface {
	...
	RegisterNewUser(context.Context, *RegisterNewUserReq) (*RegisterNewUserRes, error)
...
func (UnimplementedAuthGrpcServiceServer) RegisterNewUser(context.Context, *RegisterNewUserReq) (*RegisterNewUserRes, error) {
...
func _AuthGrpcService_DeleteUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/AuthGrpcService/DeleteUser",
	}
...
func _AuthGrpcService_GetUidFromEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/AuthGrpcService/GetUidFromEmail",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AuthGrpcService_RegisterNewUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RegisterNewUserReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthGrpcServiceServer).RegisterNewUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/AuthGrpcService/RegisterNewUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthGrpcServiceServer).RegisterNewUser(ctx, req.(*RegisterNewUserReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthGrpcService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuthGrpcService_RegisterNewUser_Handler,
		},
	},
